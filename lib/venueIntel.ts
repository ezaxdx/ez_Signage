...
/**
 * HOTFIX (2026-05-20): 32 표준 행사장 풀네임(약어) 형식으로 통일.
 *   시설 가이드 동적 SOT = DB venues.name (단일 진실).
 *   본 맵은 normalizeVenueName이 raw 입력 → 표준명으로 변환 시 사용.
 *   PO가 시설 가이드에 신규 행사장 추가 → DB venues INSERT → 자동 반영.
 *   본 맵은 핵심 32 표준 + 흔한 별칭만 (확장은 DB 우선·맵은 fallback).
 */
const VENUE_ALIAS_MAP: Record<string, string> = {
  ...
  '코엑스 컨벤션센터': '코엑스(COEX)',
  'ddp': '동대문디자인플라자(DDP)',
  '동대문디자인플라자': '동대문디자인플라자(DDP)',
  '동대문 디자인 플라자': '동대문디자인플라자(DDP)',
  'kspo': '올림픽공원체육관(KSPO)',
  'kspo dome': '올림픽공원체육관(KSPO)',
  '올림픽공원': '올림픽공원체육관(KSPO)',
  'setec': '서울무역전시컨벤션센터(SETEC)',
  '서울무역전시컨벤션센터': '서울무역전시컨벤션센터(SETEC)',
  '롯데호텔 서울': '롯데호텔 서울',
  '롯데호텔': '롯데호텔 서울',
  '그랜드하얏트 서울': '그랜드하얏트 서울',
  '그랜드하얏트서울': '그랜드하얏트 서울',
  '그랜드 하얏트 서울': '그랜드하얏트 서울',
  '그랜드하얏트': '그랜드하얏트 서울',
  '더플라자 서울': '더플라자 서울',
  '더 플라자 서울': '더플라자 서울',
  '더플라자 호텔 서울': '더플라자 서울',
  ...
  '킨텍스': '킨텍스(KINTEX)',
  'kintex': '킨텍스(KINTEX)',
  '킨텍스 제1전시장': '킨텍스(KINTEX)',
  '킨텍스 제2전시장': '킨텍스(KINTEX)',
  '수원컨벤션센터': '수원컨벤션센터',
  '송도컨벤시아': '송도컨벤시아',
  '인천 송도컨벤시아': '송도컨벤시아',
  '인천 송도': '송도컨벤시아',
  ...
  // ── 경상 5 ────────────────────────────────────────────
  'exco': '대구컨벤션센터(EXCO)',
  '대구컨벤션센터': '대구컨벤션센터(EXCO)',
  '대구 exco': '대구컨벤션센터(EXCO)',
  'gumico': '구미컨벤션센터(GUMICO)',
  '구미컨벤션센터': '구미컨벤션센터(GUMICO)',
  '안동국제컨벤션센터': '안동국제컨벤션센터',
  'hico': '경주화백컨벤션센터(HICO)',
  '경주화백컨벤션센터': '경주화백컨벤션센터(HICO)',
  '경주': '경주화백컨벤션센터(HICO)',
  'ueco': '울산컨벤션센터(UECO)',
  '울산컨벤션센터': '울산컨벤션센터(UECO)',
  // ── 부산·경남 3 ──────────────────────────────────────
  'bexco': '벡스코(BEXCO)',
  '벡스코': '벡스코(BEXCO)',
  '라한호텔·라한셀렉트': '라한호텔·라한셀렉트',
  '라한호텔': '라한호텔·라한셀렉트',
  '라한셀렉트': '라한호텔·라한셀렉트',
  'ceco': '창원컨벤션센터(CECO)',
  '창원컨벤션센터': '창원컨벤션센터(CECO)',
  // ── 호남 2 ────────────────────────────────────────────
  'gsco': '광주김대중컨벤션센터(GSCO)',
  '광주김대중컨벤션센터': '광주김대중컨벤션센터(GSCO)',
  '광주 김대중컨벤션센터': '광주김대중컨벤션센터(GSCO)',
  '김대중컨벤션센터': '광주김대중컨벤션센터(GSCO)',
  '여수엑스포컨벤션센터': '여수엑스포컨벤션센터',
  '여수컨벤션센터': '여수엑스포컨벤션센터',
  // ── 제주 2 ────────────────────────────────────────────
  'icc': '제주국제컨벤션센터(ICC)',
  'icc jeju': '제주국제컨벤션센터(ICC)',
  '제주국제컨벤션센터': '제주국제컨벤션센터(ICC)',
  '제주컨벤시아': '제주국제컨벤션센터(ICC)',
  '제주신라호텔': '제주신라호텔',
}
