...
export const VENUE_FACILITY_GUIDE_SEED: VenueFacilityGuide[] = [
  ...
  // ══════════════════════════════════════════════════════════════
  // 골격 시드 21건 (2026-05-19 자동 생성) — 사용자 명시 "필요 자료·무조건 코드 반영"
  // 출처: scripts/generate_facility_guide_skeletons.mjs
  // 보강 필요: 운영팀 연락처·표준 규격·리깅 조건 = 폴더 안내·임대자료 PDF 분석 후
  // ══════════════════════════════════════════════════════════════
  {
    venue_key: 'bexco_basic', venue_name: 'BEXCO (벡스코) — 부산',
    install_allowed: [
      { category: 'X배너', status: 'allowed', note: '전시장·로비 자립형 스탠드.' },
      { category: '세로현수막', status: 'allowed', note: '600×1800 표준.', standard_width_mm: 600, standard_height_mm: 1800 },
      { category: '가로현수막', status: 'conditional', note: '외벽 = 운영팀 사전 협의.' },
      { category: '통천 배너', status: 'conditional', note: '운영팀 협의.' },
      { category: '천정배너', status: 'conditional', note: '리깅 = 운영팀 도면.' },
      { category: '포디움 타이틀', status: 'allowed', note: '600×200mm.', standard_width_mm: 600, standard_height_mm: 200 },
      { category: 'A4·A3 POP', status: 'allowed', note: '아크릴 스탠드.' },
    ],
    mount_methods: { taka: 'denied', magnet: 'denied', adhesive: 'denied', hanger: 'conditional', rope: 'conditional', note: '운영팀 협의.' },
    rigging: { available: true, max_load_kg: 50, note: '운영팀 도면.' },
    safety: { fire: '난연 2급 이상.', fall: '리깅 2점.', electric: '220V.', weather: '실내.', note: '비상구 가림 X.' },
    warnings: [{ type: '운영팀 사전 협의 의무', description: 'BEXCO 운영팀 연락처 = 안내·임대자료 PDF 분석 후 보강.' }],
    digital_signage: { allowed_locations: ['전시장 LED (협의)'], content_review: true },
    last_updated: '2026-05-19',
    special_notes: ['【골격 시드 — 2026-05-19】 지역: 부산광역시. 안내·임대자료 PDF 분석 후 보강 필요.'],
  },
  {
    venue_key: 'exco_basic', venue_name: 'EXCO — 대구',
    install_allowed: [
      { category: 'X배너', status: 'allowed', note: '전시장 자립형.' },
      { category: '세로현수막', status: 'allowed', note: '600×1800.', standard_width_mm: 600, standard_height_mm: 1800 },
      { category: '가로현수막', status: 'conditional', note: '운영팀 협의.' },
      { category: '통천 배너', status: 'conditional', note: '운영팀 협의.' },
      { category: '천정배너', status: 'conditional', note: '운영팀 도면.' },
      { category: '포디움 타이틀', status: 'allowed', note: '600×200mm.', standard_width_mm: 600, standard_height_mm: 200 },
      { category: 'A4·A3 POP', status: 'allowed', note: '아크릴 스탠드.' },
    ],
    mount_methods: { taka: 'denied', magnet: 'denied', adhesive: 'denied', hanger: 'conditional', rope: 'conditional', note: '운영팀 협의.' },
    rigging: { available: true, max_load_kg: 50, note: '운영팀 도면.' },
    safety: { fire: '난연 2급 이상.', fall: '리깅 2점.', electric: '220V.', weather: '실내.', note: '비상구 가림 X.' },
    warnings: [{ type: '운영팀 사전 협의 의무', description: 'EXCO 운영팀 연락처 = 임대자료 PDF 분석 후 보강.' }],
    digital_signage: { allowed_locations: ['전시장 LED (협의)'], content_review: true },
    last_updated: '2026-05-19',
    special_notes: ['【골격 시드 — 2026-05-19】 지역: 대구광역시.'],
  },
  {
    venue_key: 'gsco_basic', venue_name: 'GSCO (광주김대중컨벤션센터) — 광주',
    install_allowed: [
      { category: 'X배너', status: 'allowed', note: '전시장 자립형.' },
      { category: '세로현수막', status: 'allowed', note: '600×1800.', standard_width_mm: 600, standard_height_mm: 1800 },
      { category: '가로현수막', status: 'conditional', note: '운영팀 협의.' },
    ...
    rigging: { available: true, max_load_kg: 50, note: '운영팀 도면.' },
    safety: { fire: '난연 2급 이상.', fall: '리깅 2점.', electric: '220V.', weather: '실내.', note: '비상구 가림 X.' },
    warnings: [{ type: '운영팀 사전 협의 의무', description: 'GSCO 운영팀 연락처 = 안내 PDF 분석 후 보강.' }],
    digital_signage: { allowed_locations: ['전시장 LED (협의)'], content_review: true },
    last_updated: '2026-05-19',
    special_notes: ['【골격 시드 — 2026-05-19】 지역: 광주광역시.'],
  },
  {
    venue_key: 'the_shilla_basic', venue_name: 'THE SHILLA 서울신라호텔 — 서울',
    install_allowed: [
      { category: 'X배너', status: 'allowed', note: '연회장·로비 자립형.' },
      { category: '세로현수막', status: 'allowed', note: '600×1800.', standard_width_mm: 600, standard_height_mm: 1800 },
      { category: '가로현수막', status: 'conditional', note: '호텔 영업팀 협의.' },
      { category: '통천 배너', status: 'conditional', note: '영업팀 협의.' },
      { category: '천정배너', status: 'conditional', note: '연회장 리깅 = 영업팀 협의.' },
      { category: '포디움 타이틀', status: 'allowed', note: '600×200mm.', standard_width_mm: 600, standard_height_mm: 200 },
      { category: 'A4·A3 POP', status: 'allowed', note: '아크릴 스탠드.' },
    ],
    mount_methods: { taka: 'denied', magnet: 'denied', adhesive: 'denied', hanger: 'conditional', rope: 'conditional', note: '호텔 영업팀 협의.' },
    rigging: { available: true, max_load_kg: 50, note: '연회장 도면.' },
    safety: { fire: '난연 2급 이상.', fall: '리깅 2점.', electric: '220V.', weather: '실내.', note: '비상구 가림 X.' },
    warnings: [{ type: '호텔 영업팀 사전 협의', description: 'THE SHILLA 영업팀 연락처 = 안내자료 분석 후 보강.' }],
    digital_signage: { allowed_locations: ['연회장 LED (협의)'], content_review: true },
    last_updated: '2026-05-19',
    special_notes: ['【골격 시드 — 2026-05-19】 호텔 영업팀 사전 협의 의무. 지역: 서울특별시.'],
  },
  {
    venue_key: 'ceco_basic', venue_name: 'CECO (창원컨벤션센터) — 경남',
    install_allowed: [
      { category: 'X배너', status: 'allowed', note: '전시장 자립형.' },
      { category: '세로현수막', status: 'allowed', note: '600×1800.', standard_width_mm: 600, standard_height_mm: 1800 },
      { category: '가로현수막', status: 'conditional', note: '운영팀 협의.' },
    ...
    rigging: { available: true, max_load_kg: 50, note: '운영팀 도면.' },
    safety: { fire: '난연 2급 이상.', fall: '리깅 2점.', electric: '220V.', weather: '실내.', note: '비상구 가림 X.' },
    warnings: [{ type: '운영팀 사전 협의 의무', description: 'CECO 운영팀 연락처 = 안내 PDF 분석 후 보강.' }],
    digital_signage: { allowed_locations: ['전시장 LED (협의)'], content_review: true },
    last_updated: '2026-05-19',
    special_notes: ['【골격 시드 — 2026-05-19】 지역: 경상남도.'],
  },
  {
    venue_key: 'dcc_basic', venue_name: 'DCC (대전컨벤션센터) — 대전',
    install_allowed: [
      { category: 'X배너', status: 'allowed', note: '전시장 자립형.' },
      { category: '세로현수막', status: 'allowed', note: '600×1800.', standard_width_mm: 600, standard_height_mm: 1800 },
      { category: '가로현수막', status: 'conditional', note: '운영팀 협의.' },
    ...
    rigging: { available: true, max_load_kg: 50, note: '운영팀 도면.' },
    safety: { fire: '난연 2급 이상.', fall: '리깅 2점.', electric: '220V.', weather: '실내.', note: '비상구 가림 X.' },
    warnings: [{ type: '운영팀 사전 협의 의무', description: 'DCC 운영팀 연락처 = 안내 PDF 분석 후 보강.' }],
    digital_signage: { allowed_locations: ['전시장 LED (협의)'], content_review: true },
    last_updated: '2026-05-19',
    special_notes: ['【골격 시드 — 2026-05-19】 지역: 대전광역시.'],
  },
  {
    venue_key: 'hico_basic', venue_name: 'HICO (경주화백컨벤션센터) — 경주',
    install_allowed: [
      { category: 'X배너', status: 'allowed', note: '전시장 자립형.' },
      { category: '세로현수막', status: 'allowed', note: '600×1800.', standard_width_mm: 600, standard_height_mm: 1800 },
      { category: '가로현수막', status: 'conditional', note: '운영팀 협의.' },
    ...
    rigging: { available: true, max_load_kg: 50, note: '운영팀 도면.' },
    safety: { fire: '난연 2급 이상.', fall: '리깅 2점.', electric: '220V.', weather: '실내.', note: '비상구 가림 X.' },
    warnings: [{ type: '운영팀 사전 협의 의무', description: 'HICO 운영팀 연락처 = 안내 PDF 분석 후 보강.' }],
    digital_signage: { allowed_locations: ['전시장 LED (협의)'], content_review: true },
    last_updated: '2026-05-19',
    special_notes: ['【골격 시드 — 2026-05-19】 지역: 경상북도.'],
  },
  {
    venue_key: 'kspo_dome_basic', venue_name: 'KSPO DOME (올림픽공원) — 서울',
    install_allowed: [
      { category: 'X배너', status: 'allowed', note: '경기장·로비 자립형.' },
      { category: '세로현수막', status: 'allowed', note: '600×1800.', standard_width_mm: 600, standard_height_mm: 1800 },
      { category: '가로현수막', status: 'conditional', note: '운영팀 협의.' },
      { category: '통천 배너', status: 'conditional', note: '운영팀 협의.' },
      { category: '천정배너', status: 'conditional', note: '돔 리깅 = 운영팀 도면.' },
      { category: '포디움 타이틀', status: 'allowed', note: '600×200mm.', standard_width_mm: 600, standard_height_mm: 200 },
      { category: 'A4·A3 POP', status: 'allowed', note: '아크릴 스탠드.' },
    ],
    mount_methods: { taka: 'denied', magnet: 'denied', adhesive: 'denied', hanger: 'conditional', rope: 'conditional', note: '운영팀 협의.' },
    rigging: { available: true, max_load_kg: 50, note: '돔 그리드 도면.' },
    safety: { fire: '난연 2급 이상.', fall: '리깅 2점.', electric: '220V.', weather: '실내.', note: '비상구 가림 X.' },
    warnings: [{ type: '운영팀 사전 협의 의무', description: 'KSPO DOME 운영팀 연락처 = 안내 PDF 분석 후 보강.' }],
    digital_signage: { allowed_locations: ['경기장 LED (협의)'], content_review: true },
    last_updated: '2026-05-19',
    special_notes: ['【골격 시드 — 2026-05-19】 지역: 서울특별시.'],
  },
  {
    venue_key: 'setec_basic', venue_name: 'SETEC (서울무역전시컨벤션센터) — 서울',
    install_allowed: [
      { category: 'X배너', status: 'allowed', note: '전시장 자립형.' },
      { category: '세로현수막', status: 'allowed', note: '600×1800.', standard_width_mm: 600, standard_height_mm: 1800 },
      { category: '가로현수막', status: 'conditional', note: '운영팀 협의.' },
    ...
    rigging: { available: true, max_load_kg: 50, note: '운영팀 도면.' },
    safety: { fire: '난연 2급 이상.', fall: '리깅 2점.', electric: '220V.', weather: '실내.', note: '비상구 가림 X.' },
    warnings: [{ type: '운영팀 사전 협의 의무', description: 'SETEC 운영팀 연락처 = 안내 PDF 분석 후 보강.' }],
    digital_signage: { allowed_locations: ['전시장 LED (협의)'], content_review: true },
    last_updated: '2026-05-19',
    special_notes: ['【골격 시드 — 2026-05-19】 지역: 서울특별시.'],
  },
  {
    venue_key: 'yeosu_expo_basic', venue_name: '여수엑스포컨벤션센터 — 여수',
    install_allowed: [
      { category: 'X배너', status: 'allowed', note: '전시장 자립형.' },
      { category: '세로현수막', status: 'allowed', note: '600×1800.', standard_width_mm: 600, standard_height_mm: 1800 },
      { category: '가로현수막', status: 'conditional', note: '운영팀 협의.' },
    ...
    rigging: { available: true, max_load_kg: 50, note: '운영팀 도면.' },
    safety: { fire: '난연 2급 이상.', fall: '리깅 2점.', electric: '220V.', weather: '실내.', note: '비상구 가림 X.' },
    warnings: [{ type: '운영팀 사전 협의 의무', description: '여수엑스포 운영팀 연락처 = 안내 PDF 분석 후 보강.' }],
    digital_signage: { allowed_locations: ['전시장 LED (협의)'], content_review: true },
    last_updated: '2026-05-19',
    special_notes: ['【골격 시드 — 2026-05-19】 지역: 전라남도.'],
  },
  {
    venue_key: 'sejong_convention_basic', venue_name: '정부세종컨벤션센터 — 세종',
    install_allowed: [
      { category: 'X배너', status: 'allowed', note: '전시장 자립형.' },
      { category: '세로현수막', status: 'allowed', note: '600×1800.', standard_width_mm: 600, standard_height_mm: 1800 },
      { category: '가로현수막', status: 'conditional', note: '운영팀 협의.' },
    ...
    rigging: { available: true, max_load_kg: 50, note: '운영팀 도면.' },
    safety: { fire: '난연 2급 이상.', fall: '리깅 2점.', electric: '220V.', weather: '실내.', note: '비상구 가림 X.' },
    warnings: [{ type: '운영팀 사전 협의 의무', description: '정부세종 운영팀 연락처 = 안내 PDF 분석 후 보강.' }],
    digital_signage: { allowed_locations: ['전시장 LED (협의)'], content_review: true },
    last_updated: '2026-05-19',
    special_notes: ['【골격 시드 — 2026-05-19】 지역: 세종특별자치시.'],
  },
  {
    venue_key: 'signiel_seoul_basic', venue_name: '시그니엘 서울 — 서울',
    install_allowed: [
      { category: 'X배너', status: 'allowed', note: '연회장·로비 자립형.' },
      { category: '세로현수막', status: 'allowed', note: '600×1800.', standard_width_mm: 600, standard_height_mm: 1800 },
      { category: '가로현수막', status: 'conditional', note: '호텔 영업팀 협의.' },
    ...
    rigging: { available: true, max_load_kg: 50, note: '연회장 도면.' },
    safety: { fire: '난연 2급 이상.', fall: '리깅 2점.', electric: '220V.', weather: '실내.', note: '비상구 가림 X.' },
    warnings: [{ type: '호텔 영업팀 사전 협의', description: '시그니엘 영업팀 연락처 = 안내자료 분석 후 보강.' }],
    digital_signage: { allowed_locations: ['연회장 LED (협의)'], content_review: true },
    last_updated: '2026-05-19',
    special_notes: ['【골격 시드 — 2026-05-19】 호텔 영업팀 사전 협의 의무. 지역: 서울특별시.'],
  },
  {
    venue_key: 'jeju_shilla_basic', venue_name: '제주신라호텔 — 제주',
    install_allowed: [
      { category: 'X배너', status: 'allowed', note: '연회장·로비 자립형.' },
      { category: '세로현수막', status: 'allowed', note: '600×1800.', standard_width_mm: 600, standard_height_mm: 1800 },
      { category: '가로현수막', status: 'conditional', note: '호텔 영업팀 협의.' },
    ...
    rigging: { available: true, max_load_kg: 50, note: '연회장 도면.' },
    safety: { fire: '난연 2급 이상.', fall: '리깅 2점.', electric: '220V.', weather: '실내.', note: '비상구 가림 X.' },
    warnings: [{ type: '호텔 영업팀 사전 협의', description: '제주신라 영업팀 연락처 = 안내자료 분석 후 보강.' }],
    digital_signage: { allowed_locations: ['연회장 LED (협의)'], content_review: true },
    last_updated: '2026-05-19',
    special_notes: ['【골격 시드 — 2026-05-19】 호텔 영업팀 사전 협의 의무. 지역: 제주특별자치도.'],
  },
  {
    venue_key: 'josun_palace_basic', venue_name: '조선팰리스 강남 — 서울',
    install_allowed: [
      { category: 'X배너', status: 'allowed', note: '연회장·로비 자립형.' },
      { category: '세로현수막', status: 'allowed', note: '600×1800.', standard_width_mm: 600, standard_height_mm: 1800 },
      { category: '가로현수막', status: 'conditional', note: '호텔 영업팀 협의.' },
    ...
    rigging: { available: true, max_load_kg: 50, note: '연회장 도면.' },
    safety: { fire: '난연 2급 이상.', fall: '리깅 2점.', electric: '220V.', weather: '실내.', note: '비상구 가림 X.' },
    warnings: [{ type: '호텔 영업팀 사전 협의', description: '조선팰리스 영업팀 연락처 = 안내자료 분석 후 보강.' }],
    digital_signage: { allowed_locations: ['연회장 LED (협의)'], content_review: true },
    last_updated: '2026-05-19',
    special_notes: ['【골격 시드 — 2026-05-19】 호텔 영업팀 사전 협의 의무. 지역: 서울특별시.'],
  },
  {
    venue_key: 'suwon_convention_basic', venue_name: '수원컨벤션센터 — 수원',
    install_allowed: [
      { category: 'X배너', status: 'allowed', note: '전시장 자립형.' },
      { category: '세로현수막', status: 'allowed', note: '600×1800.', standard_width_mm: 600, standard_height_mm: 1800 },
      { category: '가로현수막', status: 'conditional', note: '운영팀 협의.' },
    ...
    rigging: { available: true, max_load_kg: 50, note: '운영팀 도면.' },
    safety: { fire: '난연 2급 이상.', fall: '리깅 2점.', electric: '220V.', weather: '실내.', note: '비상구 가림 X.' },
    warnings: [{ type: '운영팀 사전 협의 의무', description: '수원컨벤션 운영팀 연락처 = 안내 PDF 분석 후 보강.' }],
    digital_signage: { allowed_locations: ['전시장 LED (협의)'], content_review: true },
    last_updated: '2026-05-19',
    special_notes: ['【골격 시드 — 2026-05-19】 지역: 경기도.'],
  },
  {
    venue_key: 'gumico_basic', venue_name: 'GUMICO (구미컨벤션센터) — 구미',
    install_allowed: [
      { category: 'X배너', status: 'allowed', note: '전시장 자립형.' },
      { category: '세로현수막', status: 'allowed', note: '600×1800.', standard_width_mm: 600, standard_height_mm: 1800 },
      { category: '가로현수막', status: 'conditional', note: '운영팀 협의.' },
    ...
    rigging: { available: true, max_load_kg: 50, note: '운영팀 도면.' },
    safety: { fire: '난연 2급 이상.', fall: '리깅 2점.', electric: '220V.', weather: '실내.', note: '비상구 가림 X.' },
    warnings: [{ type: '운영팀 사전 협의 의무', description: 'GUMICO 운영팀 연락처 = 안내 PDF 분석 후 보강.' }],
    digital_signage: { allowed_locations: ['전시장 LED (협의)'], content_review: true },
    last_updated: '2026-05-19',
    special_notes: ['【골격 시드 — 2026-05-19】 지역: 경상북도.'],
  },
  {
    venue_key: 'ueco_basic', venue_name: 'UECO (울산컨벤션센터) — 울산',
    install_allowed: [
      { category: 'X배너', status: 'allowed', note: '전시장 자립형.' },
      { category: '세로현수막', status: 'allowed', note: '600×1800.', standard_width_mm: 600, standard_height_mm: 1800 },
      { category: '가로현수막', status: 'conditional', note: '운영팀 협의.' },
    ...
    rigging: { available: true, max_load_kg: 50, note: '운영팀 도면.' },
    safety: { fire: '난연 2급 이상.', fall: '리깅 2점.', electric: '220V.', weather: '실내.', note: '비상구 가림 X.' },
    warnings: [{ type: '운영팀 사전 협의 의무', description: 'UECO 운영팀 연락처 = 안내 PDF 분석 후 보강.' }],
    digital_signage: { allowed_locations: ['전시장 LED (협의)'], content_review: true },
    last_updated: '2026-05-19',
    special_notes: ['【골격 시드 — 2026-05-19】 지역: 울산광역시.'],
  },
  {
    venue_key: 'rahan_hotel_basic', venue_name: '라한호텔·라한셀렉트 — 서울',
    install_allowed: [
      { category: 'X배너', status: 'allowed', note: '연회장·로비 자립형.' },
      { category: '세로현수막', status: 'allowed', note: '600×1800.', standard_width_mm: 600, standard_height_mm: 1800 },
      { category: '가로현수막', status: 'conditional', note: '호텔 영업팀 협의.' },
    ...
    rigging: { available: true, max_load_kg: 50, note: '연회장 도면.' },
    safety: { fire: '난연 2급 이상.', fall: '리깅 2점.', electric: '220V.', weather: '실내.', note: '비상구 가림 X.' },
    warnings: [{ type: '호텔 영업팀 사전 협의', description: '라한호텔 영업팀 연락처 = 안내자료 분석 후 보강.' }],
    digital_signage: { allowed_locations: ['연회장 LED (협의)'], content_review: true },
    last_updated: '2026-05-19',
    special_notes: ['【골격 시드 — 2026-05-19】 호텔 영업팀 사전 협의 의무. 지역: 서울특별시.'],
  },
  {
    venue_key: 'sonokam_basic', venue_name: '소노캄 — 강원',
    install_allowed: [
      { category: 'X배너', status: 'allowed', note: '컨벤션홀·로비 자립형.' },
      { category: '세로현수막', status: 'allowed', note: '600×1800.', standard_width_mm: 600, standard_height_mm: 1800 },
      { category: '가로현수막', status: 'conditional', note: '리조트 영업팀 협의.' },
      { category: '통천 배너', status: 'conditional', note: '영업팀 협의.' },
      { category: '천정배너', status: 'conditional', note: '컨벤션홀 리깅 = 영업팀 협의.' },
      { category: '포디움 타이틀', status: 'allowed', note: '600×200mm.', standard_width_mm: 600, standard_height_mm: 200 },
      { category: 'A4·A3 POP', status: 'allowed', note: '아크릴 스탠드.' },
    ],
    mount_methods: { taka: 'denied', magnet: 'denied', adhesive: 'denied', hanger: 'conditional', rope: 'conditional', note: '리조트 영업팀 협의.' },
    rigging: { available: true, max_load_kg: 50, note: '컨벤션홀 도면.' },
    safety: { fire: '난연 2급 이상.', fall: '리깅 2점.', electric: '220V.', weather: '실내. 동절기 추가 점검.', note: '비상구 가림 X.' },
    warnings: [{ type: '리조트 영업팀 사전 협의', description: '소노캄 영업팀 연락처 = 안내자료 분석 후 보강.' }],
    digital_signage: { allowed_locations: ['컨벤션홀 LED (협의)'], content_review: true },
    last_updated: '2026-05-19',
    special_notes: ['【골격 시드 — 2026-05-19】 리조트 영업팀 사전 협의 의무. 지역: 강원특별자치도.'],
  },
  {
    venue_key: 'andong_convention_basic', venue_name: '안동국제컨벤션센터 — 안동',
    install_allowed: [
      { category: 'X배너', status: 'allowed', note: '전시장 자립형.' },
      { category: '세로현수막', status: 'allowed', note: '600×1800.', standard_width_mm: 600, standard_height_mm: 1800 },
      { category: '가로현수막', status: 'conditional', note: '운영팀 협의.' },
    ...
    rigging: { available: true, max_load_kg: 50, note: '운영팀 도면.' },
    safety: { fire: '난연 2급 이상.', fall: '리깅 2점.', electric: '220V.', weather: '실내.', note: '비상구 가림 X.' },
    warnings: [{ type: '운영팀 사전 협의 의무', description: '안동컨벤션 운영팀 연락처 = 안내 PDF 분석 후 보강.' }],
    digital_signage: { allowed_locations: ['전시장 LED (협의)'], content_review: true },
    last_updated: '2026-05-19',
    special_notes: ['【골격 시드 — 2026-05-19】 지역: 경상북도.'],
  },
